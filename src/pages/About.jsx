export default function About() {
  return (
    <section className="relative mt-24 px-6 py-16 max-w-4xl mx-auto bg-black shadow-lg rounded-2xl border border-gray-100 overflow-hidden">
      
      <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-yellow-400 via-rose-400 to-pink-500" />

      <div className="relative z-10">
        <h1 className="text-4xl font-extrabold text-white mb-6 border-b pb-2 border-gray-200">
          About <span className="text-pink-600">InBrief</span>
        </h1>

        <p className="mb-6 text-lg text-white leading-relaxed">
          <strong className="text-pink-600">InBrief</strong> is a sleek, intuitive news aggregator app built with React. It delivers trending and categorized headlines from trusted sources around the globe using a powerful news API.
        </p>
